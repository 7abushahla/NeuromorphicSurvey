...
The manifest at `data/figure-manifest.json` is authoritative. It contains 26 figures, all
implemented (25 static plus the interactive route map, Figure 25), none planned. Display numbers
