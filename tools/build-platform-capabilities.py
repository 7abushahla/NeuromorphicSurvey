...
PLATFORMS: tuple[dict[str, object], ...] = (
    {
        ...
        "fields": {
            ...
            "threshold_reset": field("transformed", "Preserve reset by subtraction used by classical rate conversion.", "Native Loihi 1 reset clears the compartment. NxTF represents subtraction reset with a two-compartment recurrent inhibition construction.", "Table 2 comparison; historical route documented by the official example repository"),
